...
namespace ExpTreeLib
{
    ...
    /// <summary>
    /// Contains the User Control <see cref="ExpTreeLib.ExpTree">ExpTree</see>, the major Class <see cref="ExpTreeLib.ExpTree">CShellItem</see>,
    ...
    /// It also contains the Class <see cref="ContextMenu">WindowsContextMenu</see> that provides the infrastucture 
